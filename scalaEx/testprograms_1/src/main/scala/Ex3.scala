...
object Main3 extends App {
  ...
  acct1.withdraw(100) // No log message is printed // because there is no definition

  println("Overdrawing acct2");
  val acct2 = new SavingsAccount3 with ConsoleLogger3 // we are extending another trait
  acct2.withdraw(100)
}
