...
object SepsisStream {
  ...
  //  hbaseContext.streamBulkPut[Patient](patientStream, patientTable, HBaseUtil.insertIncomingDataIntoHBase, true)
    ...
    //  patientdf.selectExpr()
  //patientdf.saveAsParquetFile("/home/edureka/Downloads/sprue-master/output/patientdf/")
      //print batch details.
      ...
      countMatrix.show()
   //countMatrix.insertInto("default.test", true);

      //countMatrix.saveAsParquetFile("/home/edureka/Downloads/sprue-master/output/countMatrix/")
